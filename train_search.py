...
parser.add_argument('--data', type=str, default='/ceph/aseem-volume/full/search/05_1/data/', help='location of the data corpus')
...
args.save = '/ceph/aseem-volume/full/search/05_1/logging'
